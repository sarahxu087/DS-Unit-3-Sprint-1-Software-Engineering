...
part 7
for the code review, I check the Flaws or potential flaws that may break the project. I would like people that can point out the mistake that i made and let me fix it before I going too deep.

for container:

 Containers require less system resources than traditional or hardware virtual machine environments because they don't include operating system images. Increased portability.